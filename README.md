...
![tribe](https://github.com/user-attachments/assets/a8807360-a37a-40e4-b023-fbec445143c2)
...
Run with Docker Compose This command will build the images and start the containers for the Client, Server, MongoDB, and Redis.
